...
# ##  result for a randomly generated Matrix X as the intuitive and slow estimators
#
#
...
# test_that("B0",{
#  testthat::expect_equal(B0_intuitiv(X), B0(X))
# })

test_that("B2",{
 testthat::expect_equal(B2_intuitiv(X), B2_cpp(Y))
})

test_that("B3",{
  testthat::expect_equal(B3_intuitiv(X), B3_cpp(Y))
})
